...
import 'package:gjhgjbkj/screens/details/my_camera/services/dio_upload_serice.dart';
import 'package:gjhgjbkj/screens/details/my_camera/services/http_upload_service.dart';
...
class MyCamera extends StatefulWidget {
  MyCamera({Key? key, required this.title}) : super(key: key);
...
class _MyCamera extends State<MyCamera> {
  ...
  Future openGallery() async {
    ...
    setState(() {
      this.imageFile = imageTemp as PickedFile?;
    });
  }
